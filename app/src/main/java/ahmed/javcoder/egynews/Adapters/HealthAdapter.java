...
public class HealthAdapter extends RecyclerView.Adapter<HealthAdapter.MyViewHolder>
{
    ...
    public HealthAdapter(Context getcontext, List<ItemModel> list)
    {
    ...
    public HealthAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        ...
        return new HealthAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final HealthAdapter.MyViewHolder viewHolder, int i)
    {
