...
public class TechnologyAdapter extends RecyclerView.Adapter<TechnologyAdapter.MyViewHolder>
{
    ...
    public TechnologyAdapter(Context getcontext, List<ItemModel> list)
    {
    ...
    @NonNull
    @Override
    public TechnologyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        view = layoutInflater.inflate(R.layout.sports_view , viewGroup , false) ;

        return new TechnologyAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final TechnologyAdapter.MyViewHolder viewHolder, int i)
    {
...
//        });
        ...
        Glide.with(context)
                .load(image)
                .placeholder(R.drawable.technology)
