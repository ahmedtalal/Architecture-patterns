...
public class ExpandableAdapter3 extends BaseExpandableListAdapter {
    private Context context ;
    private List<String> listGroup ;
    private HashMap<String , List<String>> hashMapListChild;

    public ExpandableAdapter3(Context context, List<String> listGroup, HashMap<String, List<String>> hashMapListChild) {
