...
public class ScienceAdapter extends RecyclerView.Adapter<ScienceAdapter.MyViewHolder>
{
    ...
    public ScienceAdapter(Context getcontext, List<ItemModel> list)
    {
    ...
    @NonNull
    @Override
    public ScienceAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        view = layoutInflater.inflate(R.layout.sports_view , viewGroup , false) ;

        return new ScienceAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ScienceAdapter.MyViewHolder viewHolder, int i)
    {
...
//        });
        ...
        Glide.with(context)
                .load(image)
                .placeholder(R.drawable.sciencenews)
