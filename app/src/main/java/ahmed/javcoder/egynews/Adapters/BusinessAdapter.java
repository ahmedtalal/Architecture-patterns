...
public class BusinessAdapter extends RecyclerView.Adapter<BusinessAdapter.MyViewHolder>
{
    ...
    public BusinessAdapter(Context getcontext, List<ItemModel> list)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull final BusinessAdapter.MyViewHolder viewHolder, int i)
    {
...
//        });
        ...
        Glide.with(context)
                .load(image)
                .placeholder(R.drawable.businessnews)
