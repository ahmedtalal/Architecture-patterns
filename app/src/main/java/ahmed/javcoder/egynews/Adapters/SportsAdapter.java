...
public class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.MyViewHolder>
{
    ...
    public SportsAdapter(Context getcontext, List<ItemModel> list)
    {
    ...
    @NonNull
    @Override
    public SportsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        view = layoutInflater.inflate(R.layout.sports_view , viewGroup , false) ;

        return new SportsAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final SportsAdapter.MyViewHolder viewHolder, int i)
    {
...
//        });
        ...
        Glide.with(context)
                .load(image)
                .placeholder(R.drawable.sportsnews)
